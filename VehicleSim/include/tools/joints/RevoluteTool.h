#ifndef VEHICLESIM_REVOLUTETOOL
#define VEHICLESIM_REVOLUTETOOL
...
namespace vlr
{
	...
	public:
		RevoluteTool(VehicleSim* application, Gwen::Controls::Layout::Tile* toolPanel, Gwen::Controls::Base* optionsPanel, const char* icon)
			: SelectionTool(application, toolPanel, optionsPanel, icon, "Revolute joint tool"),
			_mode(MODE_SELECT1)
		{
	...
	protected:
		RevoluteTool(const RevoluteTool&);
		...
		b2RevoluteJointDef _revoluteJointDef;
